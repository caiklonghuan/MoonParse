...
runNpm(["run", "test:project"], resolve(root, "website"));
runNpm(["run", "test:debugger"], resolve(root, "website"));
runNpm(["run", "test:conflicts"], resolve(root, "website"));
runNpm(["run", "test:incremental"], resolve(root, "website"));
runNpm(["run", "test:url-state"], resolve(root, "website"));
runNpm(["run", "test:vsix"], resolve(root, "website"));
runNpm(["run", "test:tree-sitter"], resolve(root, "website"));
runNpm(["run", "test:lint"], resolve(root, "website"));
